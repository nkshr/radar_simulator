...
#include "module/image_tracker.hpp"
//#include "module/semi_dense_mapper.hpp"
...
m_bfinish(false){
	...
	register_module<ImageTracker>("image_tracker");
	register_module<SemiDenseMapper>("semi_dense_mapper");
